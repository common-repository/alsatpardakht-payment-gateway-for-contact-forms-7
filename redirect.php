    ...
    $wpcf7 = WPCF7_ContactForm::get_current();
        ...
        $price = get_post_meta($postid, "_cf7pp_price", true);
                ...
                if (isset($value['isVaset']) && $value['isVaset'] === '1') {
                    ...
                    // get token from alsatpardakht gateway to process payment
                    $result = postToAlsatPardakht( 'https://alsatpardakht.com/IPGAPI/Api22/send.php',
                        $data );
                } else {
                    $data = [
                        'Api' => $merchantId,
                    ...
                    // get token from alsatpardakht gateway to process payment
                    $result = postToAlsatPardakht('https://alsatpardakht.com/API_V1/sign.php', $data);
                }
                    ...
                    if ( ! $result || isset( $result->errors ) || isset($result->Error) ) {
                        ...
                        echo esc_html(alsatpardakht_createPage_cf7('خطا در عملیات پرداخت', $tmp));
